...
void setup() {
    ...
    RelayState *relay_state = new RelayState("channel1", "channel1", relay, SENSOR, true, true, "boolean", 12, 0);
    RelayState *relay_state1 = new RelayState("channel2", "channel2", relay, SENSOR, true, true, "boolean", 5, 9);
    RelayState *relay_state2 = new RelayState("channel3", "channel3", relay, SENSOR, true, true, "boolean", 4, 10);
    RelayState *relay_state3 = new RelayState("channel4", "channel4", relay, SENSOR, true, true, "boolean", 15, 14);
    ...
    relay->AddProperty(relay_state1);
    relay->AddProperty(relay_state2);
    relay->AddProperty(relay_state3);
